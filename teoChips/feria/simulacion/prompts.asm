;De igual manera ta mando el estado actual del proyecto, en el cual ya se puede jugar con 3 jugadores, 
;se deberia de  muestrar el intento de cada uno de los jugadores contando el numero de toques que ha dado cada jugador 
;y al tambien se deberia ver el final se muestra el ganador con el menor numero de toques.
; Pero en la realidad es que no se muestra el numero de toques de cada jugador, Despues de mostrar los nombres de los jugadores, 
;se pasa directo a la pantalla del fin del juego, y no se muestra el numero de toques de cada jugador.

;Quiero que analises a detalle tooodo el codigo, y me des en una respuesta detallada de que es lo que esta mal, como esta corregido en cada bloque a modificar
;diciendo el numero de linea de codigo aproximado, dando de contexto unas lineas de codigo arriba y abajo de 10 lineas de codigo.
;Despues de eso la explicacion detallada de porque esta mal y como se corrigio, y si es necesario agregar algo mas al codigo.
