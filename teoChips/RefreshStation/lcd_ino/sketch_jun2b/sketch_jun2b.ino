Edita el estado actual del codigo para que el led que indica el estado de sirviendo agua cuando se inicie a servir el agua este en un nivel bajo de luminosidad bajo y a medida que pasan los 5 segundos llega a su punto maximo gradualmente , llegando en el segundo 4 en el nivel maximo de 3 niveles de luminosidad 
#include <Wire.h>
